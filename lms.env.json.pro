   {
    ...
    "CACHES": {
        ...
        "configuration": {
            "BACKEND": "django.core.cache.backends.memcached.MemcachedCache", 
            "KEY_FUNCTION": "util.memcache.safe_key", 
            "KEY_PREFIX": "devadmin-VirtualBox", 
            "LOCATION": [
                "localhost:11211"
            ]
        }, 
        ...
        "staticfiles": {
            "BACKEND": "django.core.cache.backends.memcached.MemcachedCache", 
            "KEY_FUNCTION": "util.memcache.safe_key", 
            "KEY_PREFIX": "devadmin-VirtualBox_general", 
            "LOCATION": [
                "localhost:11211"
            ]
        }
    ...
    "COMMENTS_SERVICE_KEY": "ZFO3NuGC7RTvFoE34Xf2pov5oEnUI0g7WL9", 
    "COMMENTS_SERVICE_URL": "http://localhost:18080", 
    "COMPREHENSIVE_THEME_DIR": "",
    "COMPREHENSIVE_THEME_DIRS": [
        "/edx/app/edxapp/edx-themes"
    ], 
   ...
   "FEATURES": {
    "AUTH_USE_OPENID_PROVIDER": true, 
        ...
        "PREVIEW_LMS_BASE": "preview.education-prd.learn.camara.org", 
...
"MICROSITE_CONFIGURATION": {
    ...
    "base-theme": {
        "ENABLE_COMBINED_LOGIN_REGISTRATION":true, 
        "domain_prefix":"education-prd",
        "university": "Global",
        "platform_name": "Camara Learning Academy - Global",
        "SITE_NAME": "education-prd.learn.camara.org",
        "course_org_filter": "camara-education",
        "css_overrides_file": "",
        "logo_image_url": "",
        "google_analytics_file": "", 
        "favicon_path": "base-theme/lms/static/images/favicon.ico", 
        "email_from_address": "googledeveloper@camara.ie",
        "payment_support_email": "learn@camara.org",
    ...
    "lesotho-theme": {
        "ENABLE_COMBINED_LOGIN_REGISTRATION":true, 
        "domain_prefix":"lesotho-prd",
        "university": "Lesotho",
        "platform_name": "Camara Learning Academy - Lesotho",
        "SITE_NAME": "lesotho-prd.learn.camara.org",
        "course_org_filter": "camara-lesotho",
        "css_overrides_file": "",
        "logo_image_url": "",
        "google_analytics_file": "", 
        "favicon_path": "lesotho-theme/lms/static/images/favicon.ico", 
        "email_from_address": "googledeveloper@camara.ie",
        "payment_support_email": "learn@camara.org",
        "cybersource_config_key": "",
        "ENABLE_MKTG_SITE": false,
    ...
    "kenya-theme": {
        "ENABLE_COMBINED_LOGIN_REGISTRATION":true, 
        "domain_prefix":"kenya-prd",
        "university": "Kenya",
        "platform_name": "Camara Learning Academy - Kenya",
        "SITE_NAME": "kenya-prd.learn.camara.org",
        "course_org_filter": "camara-kenya",
        "css_overrides_file": "",
        "logo_image_url": "",
        "google_analytics_file": "", 
        "favicon_path": "kenya-theme/lms/static/images/favicon.ico", 
        "email_from_address": "googledeveloper@camara.ie",
        "payment_support_email": "learn@camara.org",
        "cybersource_config_key": "",
        "ENABLE_MKTG_SITE": false,
     ...
     "ethiopia-theme": {           
        "ENABLE_COMBINED_LOGIN_REGISTRATION":true, 
        "domain_prefix":"ethiopia-prd",
        "university": "Ethiopia",
        "platform_name": "Camara Learning Academy - Ethiopia",
        "SITE_NAME": "ethiopia-prd.learn.camara.org",
        "course_org_filter": "camara-ethiopia",
        "css_overrides_file": "",
        "logo_image_url": "",
        "google_analytics_file": "", 
        "favicon_path": "ethiopia-theme/lms/static/images/favicon.ico", 
        "email_from_address": "googledeveloper@camara.ie",
        "payment_support_email": "learn@camara.org",
        "cybersource_config_key": "",
        "ENABLE_MKTG_SITE": false,
     ...
     "ireland-theme": {
        ...
        "logo_image_url": "",
        "google_analytics_file": "", 
        "favicon_path": "ireland-theme/lms/static/images/favicon.ico", 
        "email_from_address": "googledeveloper@camara.ie",
        "payment_support_email": "learn@camara.org",
        "cybersource_config_key": "",
        "ENABLE_MKTG_SITE": false,
     ...
     "zambia-theme": {           
        "ENABLE_COMBINED_LOGIN_REGISTRATION":true, 
        "domain_prefix":"zambia-prd",
        "university": "Zambia",
        "platform_name": "Camara Learning Academy - Zambia",
        "SITE_NAME": "zambia-prd.learn.camara.org",
        "course_org_filter": "camara-zambia",
        "css_overrides_file": "",
        "logo_image_url": "",
        "google_analytics_file": "", 
        "favicon_path": "zambia-theme/lms/static/images/favicon.ico", 
        "email_from_address": "googledeveloper@camara.ie",
        "payment_support_email": "learn@camara.org",
        "cybersource_config_key": "",
        "ENABLE_MKTG_SITE": false,
    ...
    "tanzania-theme": {           
        "ENABLE_COMBINED_LOGIN_REGISTRATION":true, 
        "domain_prefix":"tanzania-prd",
        "university": "Tanzania",
        "platform_name": "Camara Learning Academy - Tanzania",
        "SITE_NAME": "tanzania-prd.learn.camara.org",
        "course_org_filter": "camara-tanzania",
        "css_overrides_file": "",
        "logo_image_url": "",
        "google_analytics_file": "", 
        "favicon_path": "tanzania-theme/lms/static/images/favicon.ico", 
        "email_from_address": "googledeveloper@camara.ie",
        "payment_support_email": "learn@camara.org",
        "cybersource_config_key": "",
        "ENABLE_MKTG_SITE": false,
    ...
    "LMS_BASE": "education-prd.learn.camara.org", 
    "LMS_ROOT_URL": "https://education-prd.learn.camara.org", 
    "LOCAL_LOGLEVEL": "INFO", 
    "LOGGING_ENV": "sandbox", 
    ...
    "PLATFORM_NAME": "Camara Learning Academy", 
